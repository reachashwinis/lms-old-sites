<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AllAirwaveCert.ascx.cs" Inherits="Controls_AllAirwaveCert" %>
    ...
    <tr>
        <td style="width: 311px; height: 21px">
            <asp:Label ID="LblCaption" CssClass="lblHeader" runat="server" Font-Bold="True" ForeColor="#0000C0"
                Text="All AirWave certificates" Width="308px" Font-Italic="True" Font-Size="Small"></asp:Label></td>
    </tr>
</table>
    ...
    <tr>
        <td align="left">
            <asp:DropDownList ID="ddlCertType" runat="server" AutoPostBack="True" CssClass="ddlist"
                OnSelectedIndexChanged="ddlCertType_SelectedIndexChanged" Visible="false">
        ...
        <td align="right">
            ...
            <asp:Panel ID="pnlFilterParams" runat="server" DefaultButton="btnGo">
                ...
                <asp:TextBox ID="txtSearch" runat="Server" MaxLength="250" Columns="100" CssClass="txt"></asp:TextBox>&nbsp;<asp:ImageButton
                    ID="btnGo" AlternateText="Go" ImageUrl="~/Images/searchLens.gif" runat="server"
                    OnClick="btnGo_OnClick" ValidationGroup="btnGo" ImageAlign="AbsBottom" /></asp:Panel>
        </td>
    </tr>
    <tr style="width: 100%">
        ...
        <td class="paging" align="right">
            ...
            <asp:LinkButton ID="lnkDload" runat="server" OnClick="lnkDload_OnClick" CommandArgument="all"
                Text="Download Text"></asp:LinkButton>
            |
            <asp:LinkButton ID="lnkDloadEx" runat="server" OnClick="lnkDloadEx_OnClick" CommandArgument="allEx"
                Text="Download Excel"></asp:LinkButton>
        </td>
    </tr>
</table>
            ...
            <asp:GridView ID="gvPR" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ActCode" HeaderText="Activation Key" SortExpression="ActCode"
                        HtmlEncode="false" HeaderStyle-Wrap="false" />
