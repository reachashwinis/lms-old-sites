<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListUnassignedAWCerts.ascx.cs" Inherits="Controls_ListUnassignedAWCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />

<table>
<tr><td style="width: 375px">
    <asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Unassigned AirWave certificates"
