<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListMyEvalCerts.ascx.cs" Inherits="Controls_ListMyEvalCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 368px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="My Eval Certificates "
    Width="368px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
    </td></tr></table>
    <!-- Cooment -->
...
<table>
<tr style="width:100%">
<td class="paging" align="left" style="width: 833px">Total Records:&nbsp;<asp:label id="totalRecords" runat="server"></asp:label>&nbsp;|&nbsp;Page:&nbsp;<asp:label id="currentPage" runat="server"></asp:label>&nbsp;
