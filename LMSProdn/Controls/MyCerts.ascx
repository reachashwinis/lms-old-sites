<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyCerts.ascx.cs" Inherits="Controls_MyCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 117px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="My certificates"
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle">
            <Columns>
                ...
                <asp:BoundField DataField="CertSlNo" HeaderText="Certificate Serial No" SortExpression="CertSlNo" />
