<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AwDownloadRep.ascx.cs" Inherits="Controls_AwDownloadRep" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 357px; height: 29px;">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Airwave Download Report"
    Width="357px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
 </td></tr>
 </table>
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle">
            <Columns>
                <asp:BoundField DataField="FileNames" HeaderText="File Name" SortExpression="FileNames" />
                <asp:BoundField DataField="Email" HeaderText="Downloaded By" SortExpression="Email" />
                <asp:BoundField DataField="company_name" HeaderText="Company Name" SortExpression="company_name" />
                <asp:BoundField DataField="DownloadedOn" HeaderText="Downloaded On" SortExpression="add_ts"  />
            </Columns>
        </asp:GridView>
        </td>
        </tr>
