<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ActivateAirwaveCert.ascx.cs" Inherits="Controls_ActivateAirwaveCert" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border = "0">
<tr><td style="width: 311px; height: 21px">
<asp:Label ID="LblCaption" CssClass="lblHeader" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Activate AirWave certificates"
...
<asp:RadioButtonList ID="RdBtnLst2" runat="server" Height="34px" Width="74px">
 ...
 <asp:CompareValidator ID="CvAckyes2" runat="server" ValidationGroup="ValidAirwave" Display="Dynamic" ErrorMessage="Please Acknowledge that You will abide by the rules and Regulations of EULA"
ValueToCompare="Yes" Width="460px" ControlToValidate="RdBtnLst2"></asp:CompareValidator>
</td></tr>
 <tr></tr>
<tr>
<td colspan="1" style="width: 293px">
<asp:Button ID="btnAirwaveActivate" runat="server" CssClass="btn" Text ="Activate" ValidationGroup="ValidAirwave" OnClick="btnAirwaveActivate_Click" />
</td>
