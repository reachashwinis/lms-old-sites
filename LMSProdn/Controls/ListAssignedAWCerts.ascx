<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListAssignedAWCerts.ascx.cs" Inherits="Controls_ListAssignedAWCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0"><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Assigned AirWave Certificates"
...
<td colspan="2" align="left">
        ...
        <asp:Label ID="lblErr" runat="server" ForeColor="Red" Width="480px"></asp:Label>
