<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EvalParts.ascx.cs" Inherits="Controls_EvalParts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0"><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="List eval certificate part data"
...
<td colspan="2" align="left">
        ...
        EmptyDataText="No Eval Parts found"
