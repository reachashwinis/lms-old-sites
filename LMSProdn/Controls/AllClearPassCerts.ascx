<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AllClearPassCerts.ascx.cs" Inherits="Controls_AllClearPassCerts" %>

<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 117px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="All ClearPass certificates"
    Width="116px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
    </td>
</tr>
    </table>
...
<asp:ListItem Value="EVAL_CERTS">Evaluation Certificates</asp:ListItem>
</asp:DropDownList>
</td>
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle">
            <Columns>                                    
                ...
                <asp:BoundField DataField="LSerialNum" HeaderText="Certificate Serial No" SortExpression="SerialNum" />
                <asp:BoundField DataField="SONo" HeaderText="Sales Order" SortExpression="SerialNum" />
                <asp:BoundField DataField="CustPO" HeaderText="Purchase Order" SortExpression="CustPO" />
                <asp:BoundField DataField="EndUserPO" HeaderText="Reseller/End User PO" SortExpression="EndUserPO" />    
               ...
               <asp:BoundField DataField="ActivatedBy" HeaderText="Activated By" ReadOnly="True" SortExpression="ActivatedOn" />
            </Columns>
        </asp:GridView>
        </td>
        </tr>
