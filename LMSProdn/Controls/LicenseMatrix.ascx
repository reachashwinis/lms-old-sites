<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LicenseMatrix.ascx.cs" Inherits="Controls_LicenseMatrix" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0"><tr><td>
<asp:Label ID="LblCaption" CssClass="lblHeader" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="License Matrix"
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle"
         >
            <Columns>
                    <asp:BoundField DataField="part_id" HeaderText="Part Number" SortExpression="part_id" HeaderStyle-Wrap="false" ItemStyle-Width="30%"/> 
                    <asp:BoundField DataField="description" HeaderText="Description" SortExpression="description" HeaderStyle-Wrap="false" ItemStyle-Width="30%"/> 
                    <asp:BoundField DataField="appliesTo" HeaderText="Applies To" SortExpression="appliesTo" HeaderStyle-Wrap="false" ItemStyle-Width="40%"/>                                           
            </Columns>
        </asp:GridView>
        </td>
        </tr>
