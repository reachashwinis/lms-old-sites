<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EvalContentSec.ascx.cs" Inherits="Controls_EvalContentSec" %>
...
<tr>
<td style="width: 288px">
Customer Contact State <Font Color="Red" size="2">*</Font>
</td>
<td>
...
<tr>
<td style="width: 288px">
Expected Deal close Date <Font Color="Red" size="2">*</Font>
</td>
<td>
 <asp:TextBox ID="TxtDelCloseDt" runat="server"></asp:TextBox>
 <asp:RequiredFieldValidator ID="rfvExpectDt" runat="server" ControlToValidate="TxtDelCloseDt" ValidationGroup="vgSubmit" ErrorMessage="Expected Deal close Date is mandatory" Display="None"></asp:RequiredFieldValidator>
</td>
</tr>
<tr>
<td style="width: 288px">
Aruba Sales or SE Contact Name <Font Color="Red" size="2">*</Font>
</td>
<td>
<asp:TextBox ID="TxtSEName" runat="server" Width="298px"></asp:TextBox>
<asp:RequiredFieldValidator ID="rfvSEName" runat="server" ControlToValidate="TxtSEName" ValidationGroup="vgSubmit" ErrorMessage="Aruba Sales or SE Contact Name" Display="None"></asp:RequiredFieldValidator>
</td>
</tr>
<tr>
<td style="width: 288px">
Aruba Sales or SE Contact Email <Font Color="Red" size="2">*</Font>
</td>
<td>
<asp:TextBox ID="TxtSEemail" runat="server" Width="298px"></asp:TextBox>
<asp:RequiredFieldValidator ID="rfvSEemail" runat="server" ControlToValidate="TxtSEemail" ValidationGroup="vgSubmit" ErrorMessage="Aruba Sales or SE Contact Email is mandatory" Display="None"></asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<asp:Label  ID="lblSuccess" runat="server" Text="Content Security Provising Request submitted. You will receive an email from Aruba License Management Website after the setup for Content Security is complete." CssClass="lbl" Width="962px" ></asp:Label>
</Font>
</td>
</tr>
</table>
