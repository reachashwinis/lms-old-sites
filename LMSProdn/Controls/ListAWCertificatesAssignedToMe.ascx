<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListAWCertificatesAssignedToMe.ascx.cs" Inherits="Controls_ListAWCertificatesAssignedToMe" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="AirWave Certificates assigned to me"
...
<td class="paging" align="right" style="width: 825px">
