<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UnAssignedUsers.ascx.cs" Inherits="Controls_UnAssignedUsers" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border=0><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="UnAssigned Users"
    Width="298px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
    </td></tr></table>
...
<asp:LinkButton  ID="LinkDloadExl" runat="server" OnClick="LinkDloadExl_OnClick" CommandArgument="allEx" Text="Download Excel"></asp:LinkButton>
</td>
</tr>
</table>
