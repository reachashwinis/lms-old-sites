<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AssignCertificates.ascx.cs" Inherits="Controls_AssignCertificates" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border=0><tr><td>
<asp:Label ID="LblCaption" runat="server" CssClass="lblHeader" Font-Bold="True" ForeColor="#0000C0" Text="Assign certificates"
