<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListMyRMAedContrl.ascx.cs" Inherits="Controls_ListMyRMAedContrl" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 510px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="My Certificates Activated On RMAed Controller"
