<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListAllRMAedContrl.ascx.cs" Inherits="Controls_ListAllRMAedContrl" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 510px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Certificates Activated On RMAed Controller"
    Width="825px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
    <tr><td style="width: 510px">
<asp:Label ID="LblNote" runat="server" Font-Bold="True" ForeColor="#0000C0"
    Width="825px" CssClass="lblHeader" Font-Italic="True" Font-Size="X-Small"></asp:Label>
    </td></tr>
    </td></tr></table>
    <!-- Comment -->
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle">
            <Columns>
                ...
                <asp:BoundField DataField="ActCode" HeaderText="Activation Code" SortExpression="ActCode"  />
