<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Distributors.ascx.cs" Inherits="Controls_Distributors" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border=0><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Manage distributors"
    Width="519px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
    </td></tr></table>
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
<td align="left">
<asp:LinkButton CssClass="btn"  ID="lnkAddComp" OnClick="lnkAddComp_OnClick" runat="server" Text="Add Distributor" ></asp:LinkButton>
</td>
<td align="right">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle"
         >
           ...
           <Columns>
            ...
            <asp:BoundField DataField="ArubaIds" HeaderText="Aruba IDs" SortExpression="ArubaIds" />
            <asp:BoundField DataField="CertCount" HeaderText="Total Certificates" SortExpression="CertCount" />
