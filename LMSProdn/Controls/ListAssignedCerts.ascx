<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListAssignedCerts.ascx.cs" Inherits="Controls_ListAssignedCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0"><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Assigned certificates"
    Width="383px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
</td></tr></table>
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
 View: <td align="left" style="width: 79px">
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle"
         >
            <Columns>
                ...
                <asp:BoundField DataField="Reseller_Name" HeaderText="Assigned Reseller" SortExpression="Reseller_Name"  />
                <asp:BoundField DataField="Assigned_On" HeaderText="Assigned On" SortExpression="Assigned_On"  />
                  <asp:TemplateField SortExpression="">
           <ItemTemplate>
           <asp:LinkButton CssClass="btn"  ID="lnkUnassignCert" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Cert_Reseller_Id") %>'  OnCommand="lnkUnassignCert_OnCommand"   CommandName="UNASSIGN"  Text="Unassign ?" />
           </ItemTemplate>
           </asp:TemplateField>
        ...
        <asp:Label ID="lblErr" runat="server" ForeColor="Red" Width="346px"></asp:Label>
        
<script language="javascript" type="text/javascript">
    function lnkUnassign_Clicked()
    {
