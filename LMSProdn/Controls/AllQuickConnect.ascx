<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AllQuickConnect.ascx.cs" Inherits="Controls_AllQuickConnect"%>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" ><tr><td style="width: 360px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="All QuickConnect Certificates"
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle">
            <Columns>
                ...
                <asp:BoundField DataField="UserCount" HeaderText="User Count" SortExpression="UserCount" />     
