<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListCertificatesAssignedToMe.ascx.cs" Inherits="Controls_ListCertificatesAssignedToMe" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Certificates assigned to me"
...
<br /><asp:RequiredFieldValidator ID="rfvSearch" runat="server" ControlToValidate="txtSearch" ErrorMessage="Search text is empty" Display="dynamic" ValidationGroup="btnGo" Width="160px"></asp:RequiredFieldValidator></asp:Panel>
</td>
</tr>
</table>
<table>
<tr style="width:100%">
<td class="paging" align="left" style="height: 18px">Total Records:&nbsp;<asp:label id="totalRecords" runat="server"></asp:label>&nbsp;|&nbsp;Page:&nbsp;<asp:label id="currentPage" runat="server"></asp:label>&nbsp;
...
<td class="paging" align="right" style="width: 826px; height: 18px;">
