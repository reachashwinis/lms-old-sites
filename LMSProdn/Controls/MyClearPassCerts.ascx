<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyClearPassCerts.ascx.cs" Inherits="Controls_MyClearPassCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" width="100%">
<tr><td style="width: 117px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="My ClearPass certificates"
    Width="508px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
 </td>
</tr>
    </table>
...
<td colspan="2" align="left">
       ...
       <tr>
        <td> <b> <i>
        <a href="ImportMyLegacyClpLic.aspx">I have a ClearPass license keys that is not shown here</a> </i> </b>
        </td>
        </tr>   
        </table>
