<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListAllAccounts.ascx.cs" Inherits="Controls_ListAllAccounts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border=0><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="All accounts"
...
<td colspan="2" align="left">
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle">
            <Columns>
               <asp:BoundField ItemStyle-ForeColor="red" DataField="IsCompanyAdmin" HeaderText="" SortExpression="" />
