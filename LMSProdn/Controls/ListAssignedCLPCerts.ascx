<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListAssignedCLPCerts.ascx.cs" Inherits="Controls_ListAssignedCLPCerts" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0"><tr><td>
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Assigned ClearPass Certificates"
...
<td colspan="2" align="left">
        ...
        <asp:Label ID="lblErr" runat="server" ForeColor="Red" Width="268px"></asp:Label>
