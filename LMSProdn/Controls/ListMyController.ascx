<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListMyController.ascx.cs" Inherits="Controls_ListMyController" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0"><tr><td style="width: 413px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="System Location"
...
<td colspan="2" align="left">
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" GridLines="None" 
         ...
         Width="100%" BorderWidth="0px" PageSize="50">
            <Columns>
                <asp:BoundField DataField="SysSN" HeaderText="System S/N"/>
                <asp:BoundField DataField="SysPartId" HeaderText="System P/N" />
                <asp:BoundField DataField="SysPartDesc" HeaderText="System Desc"/>
            <asp:TemplateField>
             <ItemTemplate>
                <asp:TextBox ID="Txtloc" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Location") %>'/> 
            </ItemTemplate>
            </asp:TemplateField>
            </Columns>
            <AlternatingRowStyle CssClass="AlternatingRowStyle" />
