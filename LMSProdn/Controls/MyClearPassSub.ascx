<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyClearPassSub.ascx.cs" Inherits="Controls_MyClearPassSub" %>

<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<table border="0" width="100%"><tr><td style="width: 198px">
<asp:Label ID="LblCaption" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="Activate ClearPass certificates"
    Width="420px" CssClass="lblHeader" Font-Italic="True" Font-Size="Small"></asp:Label>
    </td>
</tr>
    </table>
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
<td>Please select the Subscription ID to activate your certificates
</td></tr>
...
<asp:TextBox ID="txtSearch" runat="Server" MaxLength="50" Columns="100" CssClass="txt"></asp:TextBox>&nbsp;<asp:ImageButton ID="btnGo" AlternateText="Go" ImageUrl="~/Images/searchLens.gif" runat="server" OnClick="btnGo_OnClick" ValidationGroup="btnGo" ImageAlign="AbsBottom" /></asp:Panel>
</td>
</tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0">
...
<td colspan="2" align="left">
        ...
        <a href="GenerateCustSubs.aspx">I need to generate new Subscription ID</a> 
        </td>
        <td style="width:50%" align="right">
        <a href="ImportMyLegacyClpLic.aspx">I have a Subscription ID that is not shown here</a> 
        </td>
        </tr>       
        <tr>
        <td>
            <asp:Label ID="LblExpiry" runat="server" Text="* The Subscription IDs in Red indicates that key is expired. Please contact Aruba Networks Support for further help." Font-Italic="True" ForeColor="Red" Visible="False"></asp:Label></td>
        </tr>
        </table>
