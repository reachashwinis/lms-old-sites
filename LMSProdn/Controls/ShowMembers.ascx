<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowMembers.ascx.cs" Inherits="Controls_ShowMembers" %>
<link href="../CSS/Style.css" rel="stylesheet" type="text/css" />
<asp:Label ID="lblCompanyInfo" runat="server" CssClass="lblHeader"></asp:Label><br />
 <asp:Label ID="lblErr" runat="server" CssClass="lblError"></asp:Label><br />
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
<td align="left">
<asp:LinkButton CssClass="btn"  ID="lnkAddMembers" OnClick="lnkAddMembers_OnClick" runat="server" Text="Add members"></asp:LinkButton>
</td>
        ...
        EmptyDataRowStyle-CssClass="AlternatingRowStyle"
         >
            <Columns>
                ...
                <asp:TemplateField SortExpression="" HeaderText="Remove">
                    <ItemTemplate>
                    <asp:LinkButton CssClass="btn"  ID="lnkRemMember" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "AcctID") %>' OnCommand="lnkRemMember_OnCommand"   CommandName="REMOVEMEMBER"  Text="Remove" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
